...
public class OperatorMenu extends JFrame {
	...
	public OperatorMenu() {
		...
		// RAPORLAR
		ImageIcon raporIcon = new ImageIcon("src/üys/raporlar.png");
		...
		// MAKİNE GİRİŞİ
		ImageIcon makineIcon = new ImageIcon("src/üys/makineGirisi.png");
		...
		// PLANLAMA
		ImageIcon planIcon = new ImageIcon("src/üys/planlama.png");
		...
		// DURUŞ / KAYIP
		ImageIcon durusIcon = new ImageIcon("src/üys/durusKayip.png");
